...
defmodule Noizu.EmailService.V3.Email.Binding.Substitution.Dynamic.Selector do
  @vsn 1.0
  @type t :: %__MODULE__{
               selector: list,
             }
  ...
  def auto_expand({:ref, _m, _id} = ref, state, context, options) do
    ...
    cond do
      ...
      v = Noizu.RestrictedAccess.Protocol.restricted_view(Noizu.ERP.entity!(ref), context, options) ->
  ...
  def auto_expand(v, state, context, options) do
    {Noizu.RestrictedAccess.Protocol.restricted_view(v, context, options),state}
  end
...
defimpl Noizu.RuleEngine.ScriptProtocol, for: Noizu.EmailService.V3.Email.Binding.Substitution.Dynamic.Selector do
...
# Inspect Protocol
#=============================================================================
defimpl Inspect, for: Noizu.EmailService.V3.Email.Binding.Substitution.Dynamic.Selector do
