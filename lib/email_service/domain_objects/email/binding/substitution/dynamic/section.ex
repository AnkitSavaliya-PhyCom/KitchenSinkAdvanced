...
defmodule Noizu.EmailService.V3.Email.Binding.Substitution.Dynamic.Section do
  @vsn 1.0
  ...
  def collapse_daisy_chain([h,p|t], _options) do
    cond do
      (h.section == :else || h.section == :extended_else) && p.section == :extended_else ->
        ...
        f = %Noizu.EmailService.V3.Email.Binding.Substitution.Dynamic.Formula.IfThen{
...
defimpl Noizu.RuleEngine.ScriptProtocol, for: Noizu.EmailService.V3.Email.Binding.Substitution.Dynamic.Section do
