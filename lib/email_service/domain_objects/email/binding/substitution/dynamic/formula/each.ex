...
defmodule Noizu.EmailService.V3.Email.Binding.Substitution.Dynamic.Formula.Each do
  @vsn 1.0
  @type t :: %__MODULE__{
...
defimpl Noizu.RuleEngine.ScriptProtocol, for: Noizu.EmailService.V3.Email.Binding.Substitution.Dynamic.Formula.Each do
