...
defmodule Noizu.EmailService.V3.Email.Binding.Substitution.Dynamic do
  @vsn 1.0
  ...
  alias Noizu.EmailService.V3.Email.Binding.Substitution.Dynamic.Error
  alias Noizu.EmailService.V3.Email.Binding.Substitution.Dynamic.Effective
          ...
          [m] ->
            case extended_extract_selector(this, String.trim(m), options) do
              ...
              {{clause, _pipes}, this} ->
                ...
                %__MODULE__{this| section_stack: [new_section|this.section_stack]}
            end
        end
...
defimpl Noizu.RuleEngine.ScriptProtocol, for: Noizu.EmailService.V3.Email.Binding.Substitution.Dynamic do
