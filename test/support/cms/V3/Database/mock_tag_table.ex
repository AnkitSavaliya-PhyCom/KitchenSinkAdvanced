defmodule Noizu.Support.V3.CMS.Database.Article.Tag.MockTable do
  ...
  defmodule DefaultStrategy do
    @stub %{}
    @table Noizu.V3.CMS.Database.Tag.Table
    ...
    def read!(_mock_settings, key) do
      Noizu.Support.V3.CMS.Database.MnesiaEmulator.get(@table, key, @stub[key])
    end
    ...
    def write!(_mock_settings, record) do
      Noizu.Support.V3.CMS.Database.MnesiaEmulator.write_bag(@table, record.article, record)
    end
    ...
    def delete!(_mock_settings, key) do
      Noizu.Support.V3.CMS.Database.MnesiaEmulator.delete(@table, key)
    end
